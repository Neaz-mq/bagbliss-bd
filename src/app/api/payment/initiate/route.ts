...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const sslPayload = {
      ...
      cus_state: input.shipping.division,
      cus_postcode: input.shipping.postalCode || '1000',
      cus_country: 'Bangladesh',
      ship_name: input.shipping.fullName,
      ship_add1: input.shipping.address,
      ship_city: input.shipping.district,
      ship_state: input.shipping.division,
      ship_postcode: input.shipping.postalCode || '1000',
