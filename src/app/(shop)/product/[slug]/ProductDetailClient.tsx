...
export function normalizeProduct(raw: Record<string, unknown>): IProductWithImages {
  const hasDiscount =
    raw.originalPrice &&
  ...
  return {
    ...
    status: raw.isActive === false ? 'draft' : 'active',
...
type Props = {
  ...
  initialRelated: Record<string, unknown>[]
}
...
export default function ProductDetailClient({
  ...
  const product = normalizeProduct(initialProduct)
  const relatedProducts: IProduct[] = initialRelated.map(normalizeProduct)
