...
import { Menu, Bell, Search, ExternalLink, ChevronDown, LogOut } from 'lucide-react'
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flex: 1 }}>
        ...
        <label
          ...
          style={{
            ...
            cursor: 'text', maxWidth: '320px', width: '100%',
          }}
        >
          ...
          <input
            ...
            style={{
              ...
              fontSize: '0.83rem', color: '#334155', width: '100%',
            }}
          />
          <kbd style={{
            fontSize: '11px', color: '#cbd5e1', background: '#ffffff',
            border: '1px solid #e2e8f0', borderRadius: '6px',
            padding: '2px 7px', fontFamily: 'monospace', whiteSpace: 'nowrap', flexShrink: 0,
          }}>
            ⌘K
          </kbd>
        </label>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexShrink: 0 }}>
        ...
        <Link
          ...
          style={{
            ...
            fontSize: '0.8rem', fontWeight: 600, color: '#e91e8c',
            textDecoration: 'none', border: '1.5px solid rgba(233,30,140,0.2)',
        ...
        <button style={{
          ...
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          borderRadius: '11px', border: '1.5px solid #e8edf5',
          background: '#f8fafc', color: '#475569', cursor: 'pointer',
        }}>
        ...
        <div ref={dropdownRef} style={{ position: 'relative' }}>
          ...
          >
            <div style={{
              ...
              boxShadow: '0 2px 8px rgba(233,30,140,0.35)', letterSpacing: '0.02em',
            }}>
              {initials}
            </div>

            <div className="hidden md:block" style={{ textAlign: 'left' }}>
              <p style={{ fontSize: '0.82rem', fontWeight: 700, color: '#1e293b', margin: 0, lineHeight: 1, whiteSpace: 'nowrap' }}>
                {firstName}
              </p>
              <p style={{ fontSize: '0.68rem', color: '#94a3b8', margin: '2px 0 0', lineHeight: 1 }}>
                Administrator
              </p>
            </div>
          ...
          {dropdownOpen && (
            <div style={{
              ...
              <div style={{
                ...
                background: 'linear-gradient(135deg, rgba(233,30,140,0.04) 0%, rgba(244,63,94,0.02) 100%)',
              }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <div style={{ minWidth: 0 }}>
                    <p style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1e293b', margin: 0, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                      {fullName}
                    </p>
                    <p style={{ fontSize: '0.7rem', color: '#94a3b8', margin: '2px 0 0', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                      {email}
                    </p>
                  </div>
                </div>
              ...
              <div style={{ padding: '6px' }}>
                <button
                  ...
                  style={{
                    ...
                    fontSize: '0.84rem', fontWeight: 500, color: '#e11d48',
